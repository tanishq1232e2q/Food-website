...
export const AdminProvider = ({ children }) => {
    ...
    const getproducts = async () => {
        const response = await fetch("https://food-website-backend-3ij1.onrender.com/admin/getproducts", {
            method: "GET",
            headers: {
    ...
    const authuser=async()=>{
        try {
            const response=await fetch("https://food-website-backend-3ij1.onrender.com/user/getuser",{
                method:"GET",
                headers:{
                    auth:authtoken
                }
    ...
    const getimg = async () => {
        ...
        try {
            ...
            const result = await fetch("https://food-website-backend-3ij1.onrender.com/get-image", {
                method: "GET"
            })
    ...
    const alluserimg = async () => {
        ...
        try {
            ...
            const result = await fetch("https://food-website-backend-3ij1.onrender.com/get-userimg", {
                method: "GET"
            })
