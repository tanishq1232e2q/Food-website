...
export default function Aminusers() {
    ...
    const getuseradmin = async (index) => {
        try {
            ...
            // e.preventDefault()
            const response = await fetch(`https://food-website-backend-jwf8.onrender.com/admin/users`, {
                method: "GET",
                headers: {
    ...
    const deluser = async (id) => {
        try {
            ...
            // e.preventDefault()
            const response = await fetch(`https://food-website-backend-jwf8.onrender.com/admin/delusers/${id}`, {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    const updateuser=async(yesid)=>{
        try {
            ...
            // e.preventDefault()
            const response = await fetch(`https://food-website-backend-jwf8.onrender.com/admin/upusers/${yesid}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
