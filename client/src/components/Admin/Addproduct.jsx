...
export default function Addproduct() {
    ...
    const fetchimg = async (e) => {
        ...
        const result = await fetch("https://food-website-backend-jwf8.onrender.com/upload-image", {
            method: "POST",
            body: formdata,
    ...
    const submitadd = async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://food-website-backend-jwf8.onrender.com/admin/addproducts", {
                method: "POST",
                headers: {
