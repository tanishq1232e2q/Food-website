...
export default function Orders() {
  const { logout, count, sum, order,ok,setok,useradmin } = useadmin()
  ...
  const handleorder = () => {
    if (ok == true) {
      ...
      Swal.fire({
        ...
        text: "First fill shipping address",
  ...
  return (
    ...
    <>
      ...
      <div className='order'>
        ...
        <div>
            <h1 style={{textAlign:"center",marginBottom:"2rem"}}>Payment Portal</h1>
          <form class="row g-3">
            <div class="col-md-6">
        ...
        <div className='payment'>
          <div className="box">
            <div>
              ...
              <span className='text-info'>Total Order</span>: <span>{sums}$</span>
            </div>
            <div>

              <span className='text-danger'>Charges</span>: <span>{charge}$</span>
            </div>
            <div>

              <span>Total payment</span>: <span>{parseInt(sums) + parseInt(charge)}$</span>
            </div>
            <Link><button onClick={handleorder} className='btn btn-success'>Make Payment</button></Link>
          </div>
        </div>
